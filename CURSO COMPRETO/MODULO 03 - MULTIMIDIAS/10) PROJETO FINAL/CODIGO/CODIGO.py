...
def start(message):
    ...
    video_button = InlineKeyboardButton("ENVIAR VIDEO", callback_data="send_video")
    ...
    bot.reply_to(message, "ESCOLHA O TIPO DE MÍDIA QUE DESEJA QUE EU ENVIE:", reply_markup=markup)
