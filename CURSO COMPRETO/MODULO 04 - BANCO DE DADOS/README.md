...
2. **Tecnologias:**
   - No curso, nos concentraremos no uso de bancos de dados MySQL, MongoDB e JSON. Essas tecnologias são comumente utilizadas e oferecem recursos poderosos para armazenamento e gerenciamento de dados. No entanto, você também receberá uma visão geral sobre outros tipos de bancos de dados, preparando-o para explorar diferentes opções no futuro, conforme necessário para projetos específicos.
